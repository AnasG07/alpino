...
function ChangePassword() {
  ...
  return (
    <div>
      <div className={classes.pageTitle}>{t('changePassword')}</div>
      ...
      <Field
        ...
        name="oldPassword">
        <TextInput type="password" id={`oldPassword-${uniqueId}`} {...getInputProps('oldPassword')} />
      ...
      <Field
        ...
        name="newPassword">
        <TextInput type="password" id={`newPassword-${uniqueId}`} {...getInputProps('newPassword')} />
      ...
      {submitWasSuccessful && (
        <InlineAlert alertType="success" className={classes.inlineAlert} message={t('passwordChanged')} />
      )}
