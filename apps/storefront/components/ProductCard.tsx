  ...
  return (
    <span className="flex flex-col p-8 min-height-35 mr-8 rounded-large bg-greyCard hover-main">
      ...
      <div className="flex flex-row justify-between items-center pt-10 hover-show">
        <button className="rounded-full py-3 text-base px-8 outline-none border-none bg-black max-w-8 w-full flex justify-center">
          Details
        </button>
        <button className="rounded-full text-base py-3 px-8 outline-none border-none bg-white text-black  max-w-8 w-full flex justify-center">
          {buttonText}
        </button>
      </div>
