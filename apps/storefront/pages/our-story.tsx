  ...
  return (
    <>
      ...
      <main className="bg-black">
        ...
        <div className="min-height-60 bg-black flex flex-row">
          <div className="pl-30 py-20 pr-24 max-width-50 flex flex-col justify-between">
          ...
          <img src="/us.jpeg" className={classNames(styles['height-60'], 'w-full max-width-50')} />
        </div>
        <div className={classNames(styles['min-height-39'], 'bg-black-about  flex justify-center items-center')}>
          <div className="max-w-screen-lg">
            <p className="text-white leading-loose text-xl text-center">Innovation further and forward.</p>
            <p className="text-white leading-loose text-xl text-center">
            ...
            <p className="text-white leading-loose text-xl text-center pt-2">
        ...
        <div className="min-height-60 bg-black flex flex-row">
          <img src="/eye.jpeg" className={classNames(styles['height-60'], 'w-full max-width-50')} />
          <div className="pl-30 py-20 pr-24 max-width-50 flex flex-col justify-between">
            <h1 className="text-5xl text-white leading-16 text-right">Vision</h1>
            <h3 className="text-2xl text-white leading-16 text-right">
